...
mod=read.table("ctx_dge_bacon/CTX_Dge_Bacon_HumanID.txt",sep="\t",header=T)
...
dir.create("ctx_dge_bacon/GO_CTX/")
dir.create("ctx_dge_bacon/GO_CTX/GO_BP/")
dir.create("ctx_dge_bacon/GO_CTX/GO_MF/")
dir.create("ctx_dge_bacon/GO_CTX/GO_CC/")

net=levels(mod$Direction)
for (i in 1:length(dfBP)) write.table(dfBP[[i]], file = paste("ctx_dge_bacon/GO_CTX/GO_BP/BP_", net[[i]], ".txt",sep = ""),sep="\t",quote=F)
for (i in 1:length(dfMF)) write.table(dfMF[[i]], file = paste("ctx_dge_bacon/GO_CTX/GO_MF/MF_", net[[i]], ".txt",sep = ""),sep="\t",quote=F)
for (i in 1:length(dfCC)) write.table(dfCC[[i]], file = paste("ctx_dge_bacon/GO_CTX/GO_CC/CC_", net[[i]], ".txt",sep = ""),sep="\t",quote=F)

# Create Plots
setwd("ctx_dge_bacon/GO_CTX/")
