...
mod=read.table("str_dge/STR_Dge_HumanID.txt",sep="\t",header=T)
...
dir.create("str_dge/GO_STR/")
dir.create("str_dge/GO_STR/GO_BP/")
dir.create("str_dge/GO_STR/GO_MF/")
dir.create("str_dge/GO_STR/GO_CC/")

net=levels(mod$Direction)
for (i in 1:length(dfBP)) write.table(dfBP[[i]], file = paste("str_dge/GO_STR/GO_BP/BP_", net[[i]], ".txt",sep = ""),sep="\t",quote=F)
for (i in 1:length(dfMF)) write.table(dfMF[[i]], file = paste("str_dge/GO_STR/GO_MF/MF_", net[[i]], ".txt",sep = ""),sep="\t",quote=F)
for (i in 1:length(dfCC)) write.table(dfCC[[i]], file = paste("str_dge/GO_STR/GO_CC/CC_", net[[i]], ".txt",sep = ""),sep="\t",quote=F)

# Create Plots
setwd("str_dge/GO_STR/")
